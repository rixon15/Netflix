      ...
      <div className="mx-auto container px-4 py-8 h-full">
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-20 max-w-6xl mx-auto">
          <div className="mb-4 md:mb-0">
            ...
            <p className="mt-4 text-lf">{content?.overview}</p>
          </div>
          <img
        ...
        {similarContent.length > 0 && (
          <div className="mt-12 max-w-5xl mx-auto relative">
            ...
            <div
              className="flex overflow-x-hidden gap-4 pb-4 group"
              ref={sliderRef}
            >
              {similarContent.map((content) => {
                ...
                return (
                  ...
                  >
                    ...
                    />
                    <h4 className="mt-2 text-lf font-semibold">
                      {content.title || content.name}
                    </h4>
                  </Link>
                );
              ...
              />
              <ChevronLeft
                className="absolute top-1/2 -translate-y-1/2 lef-t2 w-8 h-8 opacity-0 group-hover:opacity-100 transition-all duration-300 cursor-pointer bg-red-600 text-white rounded-full"
                onClick={scrollLeft}
              />
            </div>
          </div>
