...
const SearchHistoryPage = () => {
  ...
  return (
    <div className="bg-black text-white min-h-screen">
      ...
      <div className="max-w-6xl mx-auto px-4 py-8">
        <text-3xl className="font-bold mb-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-colst-3 gap-4">
            {searchHistory?.map((entry) => (
              ...
              >
                ...
                <div className="flex flex-col">
                  <span className="text-white text-lf">{entry.title}</span>
